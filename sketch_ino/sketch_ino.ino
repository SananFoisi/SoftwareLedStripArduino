...
int _UM = 0;       //         A   	  RainbowCycle
int _DOIS = 0;     //         B   	  Rainbow
int _TRES = 0;     //         C   	  FadeInOut
int _QUATRO = 0;   //         D   	  Random
int _CINCO = 0;    //         E   	  Running Lights	(RED)
int _SEIS = 0;     //         F   	  Running Lights	(GREEN)
int _SETE = 0;     //         G   	  Running Lights  (BLUE)
int _OITO = 0;     //         H   	  Running Lights  (WHITE)
int _NOVE = 0;     //         I   	  Color Wipe      (BLUE)
